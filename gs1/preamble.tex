...
\definecolor{doc}{rgb}{0.38, 0.25, 0.32}
...
\newtcbtheorem[number within=section]{Definition}{Definizione}{enhanced,
	before skip=2mm,after skip=2mm, colback=darktan!5,colframe=darktan!80!black,boxrule=0.5mm,
	...
	boxed title style={frame code={
					...
					\path[left color=darktan!60!black,right color=darktan!60!black,
						middle color=darktan!80!black]
