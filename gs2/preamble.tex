...
\usepackage{enumitem}
\usepackage{hyperref,bookmark, theoremref}
\hypersetup{
	pdftitle={assignment},
...
\renewcommand{\chaptercolor}{doc!90}
...
\definecolor{doc}{HTML}{004059}
\definecolor{doc2}{HTML}{827518}
...
\newtcbtheorem[number within=section]{Definition}{Definizione}{enhanced,
	before skip=2mm,after skip=2mm, colback=doc2!5,colframe=doc2!80!black,boxrule=0.5mm,
...
\makeatletter
\newtcbtheorem[use counter=questioncounter]{question}{Domanda}{enhanced,
	breakable,
	colback=white,
...
\usetikzlibrary{arrows,calc,shadows.blur, backgrounds}
\tcbuselibrary{skins}
\newtcolorbox{note}[1][]{%
	enhanced jigsaw,
...
\newcommand{\dfn}[2]{\begin{Definition}[colbacktitle=doc!80]{#1}{}#2\end{Definition}}
\newcommand{\dfnc}[2]{\begin{definition}[colbacktitle=doc!80]{#1}{}#2\end{definition}}
